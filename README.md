# LIQUIDATION 💯
### Liquidation in finance is the process of bringing a business to an end and distributing its assets to claimants. It is an event that usually occurs when a company is insolvent, meaning it cannot pay its obligations when they are due. So in blockchain Dapps this also happens when a user who borrows money from a Dapp is unable to pay due to either unstable marketprice , so when this happens the person's collateral will be liquidated to pay for the loan he borrowed from the DApp 🔢
